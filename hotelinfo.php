...
function showSlides() {
  ...
  <tr>
    <th height="1061" bgcolor="#FFCE53" scope="row" align="center" valign="top" >
          <div class="content">
           ...
           <table height="100%" width="100%">
             <tr>
               <th>
                 <div class="info">
                 <h2>Contact Us...!!</h2><hr>
                 <p>Lorem ipsum dolor sit amet, consectetur <br> adipisicing elit, sed do eiusmotempor<br>incididunt ut labore et dolore aliqua.<br> Ut enim ad minim veniam,quis nostrud <br>exercitation ullamco laboris<br> nisi ut aliquip ex ea commodo</p>
                </div>
               </th>
